...
def snoc0 : Con0 → Ty0 → Con0
 := λ Γ A Con0 nil0 snoc0 => snoc0 (Γ Con0 nil0 snoc0) A

def Var0 : Con0 → Ty0 → Type 1
 := λ Γ A =>
   ∀ (Var0 : Con0 → Ty0 → Type)
...
def vz0 : ∀ {Γ A}, Var0 (snoc0 Γ A) A
 := λ Var0 vz0 vs => vz0

def vs0 : ∀ {Γ B A}, Var0 Γ A → Var0 (snoc0 Γ B) A
 := λ x Var0 vz0 vs0 => vs0 (x Var0 vz0 vs0)

def Tm0 : Con0 → Ty0 → Type 1
 := λ Γ A =>
   ∀ (Tm0  : Con0 → Ty0 → Type)
...
def var0 : ∀ {Γ A}, Var0 Γ A → Tm0 Γ A
 := λ x Tm0 var0 lam app tt pair fst snd left right case zero suc rec =>
     var0 x

def lam0 : ∀ {Γ A B} , Tm0 (snoc0 Γ A) B → Tm0 Γ (arr0 A B)
...
def app0 : ∀ {Γ A B} , Tm0 Γ (arr0 A B) → Tm0 Γ A → Tm0 Γ B
...
def fst0 : ∀ {Γ A B} , Tm0 Γ (prod0 A B) → Tm0 Γ A
...
def snd0 : ∀ {Γ A B} , Tm0 Γ (prod0 A B) → Tm0 Γ B
...
def left0 : ∀ {Γ A B} , Tm0 Γ A → Tm0 Γ (sum0 A B)
...
def right0 : ∀ {Γ A B} , Tm0 Γ B → Tm0 Γ (sum0 A B)
...
def case0 : ∀ {Γ A B C} , Tm0 Γ (sum0 A B) → Tm0 Γ (arr0 A C) → Tm0 Γ (arr0 B C) → Tm0 Γ C
...
def rec0 : ∀ {Γ A} , Tm0 Γ nat0 → Tm0 Γ (arr0 nat0 (arr0 A A)) → Tm0 Γ A → Tm0 Γ A
...
def v00 : ∀ {Γ A}, Tm0 (snoc0 Γ A) A
 := var0 vz0

def v10 : ∀ {Γ A B}, Tm0 (snoc0 (snoc0 Γ A) B) A
 := var0 (vs0 vz0)

def v20 : ∀ {Γ A B C}, Tm0 (snoc0 (snoc0 (snoc0 Γ A) B) C) A
 := var0 (vs0 (vs0 vz0))

def v30 : ∀ {Γ A B C D}, Tm0 (snoc0 (snoc0 (snoc0 (snoc0 Γ A) B) C) D) A
 := var0 (vs0 (vs0 (vs0 vz0)))

def tbool0 : Ty0
 := sum0 top0 top0

def ttrue0 : ∀ {Γ}, Tm0 Γ tbool0
 := left0 tt0

def tfalse0 : ∀ {Γ}, Tm0 Γ tbool0
 := right0 tt0

def ifthenelse0 : ∀ {Γ A}, Tm0 Γ (arr0 tbool0 (arr0 A (arr0 A A)))
 := lam0 (lam0 (lam0 (case0 v20 (lam0 v20) (lam0 v10))))

def times40 : ∀ {Γ A}, Tm0 Γ (arr0 (arr0 A A) (arr0 A A))
  := lam0 (lam0 (app0 v10 (app0 v10 (app0 v10 (app0 v10 v00)))))

def add0 : ∀ {Γ}, Tm0 Γ (arr0 nat0 (arr0 nat0 nat0))
 := lam0 (rec0 v00
      (lam0 (lam0 (lam0 (suc0 (app0 v10 v00)))))
      (lam0 v00))

def mul0 : ∀ {Γ}, Tm0 Γ (arr0 nat0 (arr0 nat0 nat0))
 := lam0 (rec0 v00
     (lam0 (lam0 (lam0 (app0 (app0 add0 (app0 v10 v00)) v00))))
     (lam0 zero0))

def fact0 : ∀ {Γ}, Tm0 Γ (arr0 nat0 nat0)
